...
def load_images(path_images, fout):
	...
	images = []
	arq = open('datasets/digits/files.txt')
	lines = arq.readlines()
	...
	print ('Done. Take a look into digits-features.txt')
	return images
...
if __name__ == "__main__":
	fout = open("digits-features.txt","w")
	images = load_images('datasets/digits/data', fout)
	fout.close